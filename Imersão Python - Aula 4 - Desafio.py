...
Original file is located at
    https://colab.research.google.com/drive/1i5fM7-5U9Z7uauNpk98GYa4i5ISpHIvk

# **Desafio: Fazer o mesmo que foi feito com as ações da Petrobrás na aula 4 com ações da Apple.**
"""
...
plt.title('AAPL - Variação do preço por data', fontsize=16) # Título do gráfico, tamanho de fonte
